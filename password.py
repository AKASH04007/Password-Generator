...
length_label = tk.Label(root, text="Password Length:", background='#00ff00', foreground='black')  
...
generate_button = tk.Button(root, text="Generate Password", command=generate_password, background='#00ff00', foreground='black')
